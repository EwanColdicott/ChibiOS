...
#define GPIOA_PIN2                  2
#define GPIOA_PIN3                  3
#define GPIOA_CAM_HSYNC             4
#define GPIOA_SPC                   5
#define GPIOA_CAM_PCLK              6
#define GPIOA_SDI                   7
#define GPIOA_PIN8                  8
...
#define GPIOB_PIN4                  4
#define GPIOB_PIN5                  5
#define GPIOB_CAM_B5                6
#define GPIOB_CAM_VSYNC             7
#define GPIOB_CAM_SCL               8
#define GPIOB_CAM_SDA               9
...
#define GPIOC_PIN4                  4
#define GPIOC_PIN5                  5
#define GPIOC_CAM_B0                6
#define GPIOC_CAM_B1                7
#define GPIOC_PIN8                  8
#define GPIOC_PIN9                  9
...
#define GPIOD_CAM_PWR_EN            6
#define GPIOD_PIN7                  7
#define GPIOD_PIN8                  8
#define GPIOD_PIN9                  9
#define GPIOD_PIN10                 10
#define GPIOD_PIN11                 11
#define GPIOD_CAM_RST               12
#define GPIOD_LED3                  13
#define GPIOD_LED5                  14
#define GPIOD_LED6                  15

#define GPIOE_CAM_B2                0
#define GPIOE_CAM_B3                1
#define GPIOE_PIN2                  2
#define GPIOE_CS_SPI                3
#define GPIOE_CAM_B4                4
#define GPIOE_CAM_B6                5
#define GPIOE_CAM_B7                6
#define GPIOE_PIN7                  7
#define GPIOE_PIN8                  8
#define GPIOE_PIN9                  9
 ...
 * PA4  - CAM_HSYNC                 (alternate TODO).
 * PA5  - SPC                       (alternate 5).
 * PA6  - CAM_PCLK                  (alternate TODO).
 * PA7  - SDI                       (alternate 5).
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_100M(GPIOA_BUTTON) |        \
                                     ...
                                     PIN_OSPEED_50M(GPIOA_CAM_HSYNC) |      \
                                     PIN_OSPEED_50M(GPIOA_SPC) |            \
                                     PIN_OSPEED_50M(GPIOA_CAM_PCLK) |       \
